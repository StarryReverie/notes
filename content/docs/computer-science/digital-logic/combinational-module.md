...
- **译码器**
    ...
    - **分级组合译码器**
        ...
        - ![Layered Decoder](/images/docs/computer-science/digital-logic/combinational-module/layered-decoder.jpg)
    - **译码器和布尔函数**
...
- **编码器**
    ...
    - **优先编码器**
        ...
        - ![Compact Truth Table](/images/docs/computer-science/digital-logic/combinational-module/compact-truth-table.jpg)
- **多路复用器**
    - **定义**
        ...
        - ![Mux](/images/docs/computer-science/digital-logic/combinational-module/mux.jpg)
    - **多重多路复用器**
...
- **加法器**
    ...
    - **全加器**
        ...
        - ![Full Adder](/images/docs/computer-science/digital-logic/combinational-module/full-adder.jpg)
    - **行波加法器**
        ...
        - ![Adder](/images/docs/computer-science/digital-logic/combinational-module/adder.jpg)
- **减法器**
    - **补码**
    ...
    - **实现**
        ...
        - ![Combined Adder](/images/docs/computer-science/digital-logic/combinational-module/combined-adder.jpg)
- **递增器**
    - 使用加法器实现：
