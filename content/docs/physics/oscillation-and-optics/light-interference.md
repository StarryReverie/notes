...
- **杨氏双缝干涉**
    - **原理图**
        - ![Youngs Double-slit Interference](/images/docs/physics/oscillation-and-optics/light-interference/youngs-double-slit-interference.png)
    - **光程差分布**
...
- **劈尖干涉**
    - **原理图**
        - ![Wedge Interference](/images/docs/physics/oscillation-and-optics/light-interference/wedge-interference.png)
    - **光程差分布**
...
- **牛顿环**
    - **原理图**
        - ![image.png](/images/docs/physics/oscillation-and-optics/light-interference/newton-ring.png)
    - **位置分布**
